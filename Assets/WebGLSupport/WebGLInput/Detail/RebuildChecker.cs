...
namespace WebGLSupport.Detail
{
    public class RebuildChecker
    {
        ...
        public bool NeedRebuild(bool debug = false)
        {
            ...
            {
                if(debug) DebugExtension.Log(string.Format("beforeString : {0} != {1}", beforeString, input.text));
            ...
            {
                if (debug) DebugExtension.Log(string.Format("beforeCaretPosition : {0} != {1}", beforeCaretPosition, input.caretPosition));
            ...
            {
                if (debug) DebugExtension.Log(string.Format("beforeSelectionFocusPosition : {0} != {1}", beforeSelectionFocusPosition, input.selectionFocusPosition));
            ...
            {
                if (debug) DebugExtension.Log(string.Format("beforeSelectionAnchorPosition : {0} != {1}", beforeSelectionAnchorPosition, input.selectionAnchorPosition));
            ...
            //{
            //    if (debug) DebugExtension.Log(string.Format("anchoredPosition : {0} != {1}", anchoredPosition, input.TextComponentRectTransform().anchoredPosition));
