...
public static class BuildPostProcess
{
    ...
    public static void IOSBuildPostProcess(BuildTarget target, string pathToBuiltProject)
    {
...
#else
        string guidProject = pbxProject.TargetGuidByName("Unity-iPhone");
#endif
        ...
        pbxProject.SetBuildProperty(guidProject, PROVISIONING_PROFILE_SPECIFIER_KEY,
            pbxProject.GetBuildPropertyForAnyConfig(guidProject, PROVISIONING_PROFILE_KEY));
